---
name: parallel-web
description: Remote web research workflow guidance with a strong emphasis on academic and scientific sources. Use this skill for search, URL extraction planning, data enrichment, or deep research reports when Swift web-search intents are insufficient. On AMA iOS, prefer metadata, HTML, and Markdown sources; binary-document extraction requires approved remote preflight.
---
