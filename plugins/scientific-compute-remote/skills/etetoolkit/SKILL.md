---
name: etetoolkit
description: Phylogenetic tree toolkit (ETE). Tree manipulation (Newick/NHX), evolutionary event detection, orthology/paralogy, NCBI taxonomy, and phylogenomics visualization planning. On AMA iOS, use SVG/Markdown artifacts or remote preflight for nonlocal exporters.
---
