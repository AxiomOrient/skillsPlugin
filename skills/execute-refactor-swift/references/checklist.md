...
- Did the pass avoid splitting a cohesive reducer, actor-backed store, command, parser, or adapter when locality is the clearer design?
...
- If a file or module was split, did the split reduce coupling more than it added access-control changes, target graph churn, or navigation cost?
