...
- Did the pass avoid splitting a cohesive workflow, parser, command, or adapter when locality is the clearer design?
...
- If they stayed in one file, is that because the workflow is easier to inspect and failure handling is easier to follow locally?
